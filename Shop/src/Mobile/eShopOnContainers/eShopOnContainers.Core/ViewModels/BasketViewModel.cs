...
namespace eShopOnContainers.Core.ViewModels
{
    public class BasketViewModel : ViewModelBase
    {
        ...
        public override async Task InitializeAsync(object navigationData)
        {
            ...
            MessagingCenter.Unsubscribe<CatalogDetailViewModel, CatalogItem>(this, MessageKeys.AddProduct);
            MessagingCenter.Subscribe<CatalogDetailViewModel, CatalogItem>(this, MessageKeys.AddProduct, async (sender, arg) =>
            {
                BadgeCount++;
